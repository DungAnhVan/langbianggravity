...
| PDF thiết kế nguồn | `assets/products/cnc-performance/clutch cover .pdf` |
| Ảnh hero CNC xuất từ PDF | `assets/products/cnc-performance/clutch-cover-design.webp` |
...
- Ảnh: `/assets/products/cnc-performance/clutch-cover-design.webp`, được render từ PDF thiết kế clutch cover.
- Overlay đen ở đáy để caption luôn đọc được.
- Caption mono: `Clutch cover drawing` và `Design / CNC / Fitment`; từ khóa thứ hai dùng lime.
