window.LANGBIANG_PRODUCT_GROUPS = [
  {
    ...
    links: [
      ...
      { label: "Rear Sprocket", href: "/products/sprockets/#rear-sprocket" },
      { label: "42CrMo4 Rear", href: "/products/sprockets/#materials" },
      { label: "7075-T6 Rear", href: "/products/sprockets/#materials" }
    ]
  },
  {
    slug: "brake-rotor",
    ...
    links: [
      ...
      { label: "Rear Brake Rotor", href: "/products/brake-rotor/#rear-brake-rotor" },
      { label: "Rotor Program", href: "/products/brake-rotor/#fitment" }
    ]
  },
  {
    slug: "cnc-performance",
    name: "CNC Performance",
    description: "CNC-machined performance covers and replacement hard parts by bike model and batch program.",
    cardCopy: "CNC-machined performance covers and replacement hard parts by bike model and batch program.",
    href: "/products/cnc-performance/",
    links: [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Sprocket Bolt Set", href: "/products/bolt-kits/#sprocket-bolt-set" },
      { label: "Rotor Bolt Set", href: "/products/bolt-kits/#rotor-bolt-set" },
      { label: "Race Hardware", href: "/products/bolt-kits/#fitment" }
    ]
  }
];
...
window.LANGBIANG_PRODUCTS = [
  ...
  },
  {
    ...
    image: "/assets/products/brake-rotor/LBG-F-KR94.webp",
  ...
  },
  {
    ...
    stock: "Program planning",
    image: "/assets/products/brake-rotor/LBG-R-KR94.webp",
    fitment: "Model-specific diameter, bolt pattern, offset, and caliper clearance",
    material: "SUS420 / rotor-grade stainless by batch",
    treatment: "Precision-cut profile, heat treatment by batch, flatness check, controlled surface finish",
  ...
  },
  {
    ...
    group: "cnc-performance",
    order: 1,
    placeholder: true,
    name: "Billet Clutch Cover",
    category: "CNC Performance",
    short: "CNC billet clutch cover by model fitment, impact exposure, sealing surface, and batch demand.",
  ...
  {
    slug: "water-pump-cover",
    group: "cnc-performance",
    order: 2,
    placeholder: true,
    name: "Water Pump Cover",
    category: "CNC Performance",
    short: "CNC-machined water pump cover program by fitment, impact exposure, and cooling-side clearance.",
    stock: "Fitment request",
    image: "",
    fitment: "Model-based fitment by sample, drawing, or measured cover",
    material: "Billet aluminum by batch",
  ...
  },
  {
    ...
    category: "CNC Performance",
    short: "CNC engine side cover program for model-based fitment, protection, sealing, and batch production.",
    stock: "Fitment request",
    image: "",
    fitment: "Model-based fitment by sample, drawing, or measured cover",
    material: "Billet aluminum by batch",
  ...
  {
    slug: "custom-cnc-cover-program",
    group: "cnc-performance",
    order: 4,
    placeholder: true,
    name: "Custom CNC Cover Program",
    category: "CNC Performance",
    short: "Small-batch CNC cover production by model, quantity, finish need, dealer program, and market.",
    stock: "Batch planning",
    image: "",
  ...
  {
    slug: "grade-5-titanium-bolt-kit",
    group: "bolt-kits",
    order: 1,
    ...
    image: "/assets/products/bolt-kits/bolt-kit-hero.png",
  ...
  },
  {
    ...
    order: 2,
    placeholder: true,
    name: "Grade 5 Titanium Sprocket Bolt Set",
    category: "Bolt Kits",
    short: "Grade 5 titanium sprocket hardware by thread, length, washer stack, torque, and bike model.",
    stock: "Batch fitment",
    image: "/assets/products/bolt-kits/bolt-kit-hero.png",
  ...
  },
  {
    ...
    order: 3,
    placeholder: true,
    name: "Grade 5 Titanium Rotor Bolt Set",
    category: "Bolt Kits",
    short: "Grade 5 titanium rotor hardware by bolt pattern, length, head clearance, heat exposure, and braking load.",
    stock: "Batch fitment",
    image: "/assets/products/bolt-kits/bolt-kit-hero.png",
  ...
  {
    slug: "measured-race-hardware-kit",
    group: "bolt-kits",
    order: 4,
    placeholder: true,
